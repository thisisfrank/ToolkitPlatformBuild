  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-supernova to-yellow-400 rounded-2xl p-8 text-shadowforce text-center">
        ...
        <h1 className="font-anton text-4xl mb-2">UPGRADE YOUR SUCCESS</h1>
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8">
        <h2 className="font-anton text-2xl text-white mb-6 text-center">Your Ascension Path</h2>
        
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          {/* Current Level */}
          <div className="text-center">
            <div className="w-16 h-16 bg-supernova rounded-full flex items-center justify-center mb-3 mx-auto">
              <CheckCircle className="w-8 h-8 text-shadowforce" />
            </div>
            <h3 className="font-jakarta font-bold text-white">Digital Products</h3>
            <p className="text-sm text-gray-400">$197 - Current Level</p>
            <span className="inline-block bg-green-500/20 text-green-400 px-2 py-1 rounded-full text-xs font-semibold mt-2 border border-green-500/30">
              ACTIVE
            </span>
          </div>
          ...
          {/* Next Level */}
          <div className="text-center">
            <div className="w-16 h-16 bg-gray-500/20 rounded-full flex items-center justify-center mb-3 mx-auto border border-gray-500/30">
              <Zap className="w-8 h-8 text-gray-400" />
            </div>
            <h3 className="font-jakarta font-bold text-white">Sourcing Service</h3>
            <p className="text-sm text-gray-400">$999/month + 5%</p>
            <span className="inline-block bg-gray-500/20 text-gray-400 px-2 py-1 rounded-full text-xs font-semibold mt-2 border border-gray-500/30">
              NEXT LEVEL
            </span>
          </div>
          ...
          {/* Premium Level */}
          <div className="text-center">
            <div className="w-16 h-16 bg-supernova/20 rounded-full flex items-center justify-center mb-3 mx-auto border border-supernova/30">
              <Crown className="w-8 h-8 text-supernova" />
            </div>
            <h3 className="font-jakarta font-bold text-white">Done-For-You</h3>
            <p className="text-sm text-gray-400">$5,500/month + 5%</p>
            <span className="inline-block bg-supernova/20 text-supernova px-2 py-1 rounded-full text-xs font-semibold mt-2 border border-supernova/30">
              PREMIUM
            </span>
          </div>
        </div>
